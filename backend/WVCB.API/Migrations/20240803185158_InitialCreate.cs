    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventMusicPieces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventMusicPieces_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventMusicPieces_MusicPieces_MusicPieceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_ApplicationUsers_LeaderId",
                        column: x => x.LeaderId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_ApplicationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_SectionId",
                table: "ApplicationUsers",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventMusicPieces_EventId",
                table: "EventMusicPieces",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventMusicPieces_MusicPieceId",
                table: "EventMusicPieces",
                column: "MusicPieceId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApplicationUsers_Sections_SectionId",
                table: "ApplicationUsers",
                column: "SectionId",
